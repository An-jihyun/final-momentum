...
const imgBtn = document.querySelector(".penBtn");
const penDiv = document.querySelector("div.penDiv");

function penToggle() {
  penDiv.classList.toggle("penMenuUp");
}

imgBtn.addEventListener("click", penToggle);
